...
import 'package:health_care/screens/chatScreen.dart';
import 'package:health_care/screens/plans.dart';
...
class _TabscreenState extends State<Tabscreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(showUnselectedLabels: true,unselectedItemColor: Colors.grey.shade800,
        onTap: selectPage,
